    ...
    return (
      ...
      <div className='grid grid-cols-2 items-center  justify-items-center sm:grid-cols-1 sm:mt-10 lg:grid-cols-2'>
             <div className='border-blue-400 border-x-4 border-y-4 hover:shadow-2xl hover:shadow-black text-cyan-600 rounded-lg text-center mt-20'>
                      <Link href="http://localhost:3000/pic1/1kg"> <Image src="/tomato.png" alt="/tomato" width={200} height={200} className="w-full"></Image></Link>
                      <Link href="http://localhost:3000/pic1/kg"> <h1 className='text-2xl font-bold'>Tomato</h1></Link>
                  ...
                  <div><Link href="https://wa.link/4q47tp"><button className='bg-black text-white px-5 py-3 rounded-full hover:shadow-black hover:shadow-2xl hover:bg-slate-500 sm:mt-10'>Place Order On Whatsapp</button></Link></div>
                  </div>
