    ...
    return (
        <div>
            ...
            sm:grid-cols-2 mb-10'>
                ...
                <div className='border-blue-400 border-x-4 border-y-4 hover:shadow-2xl hover:shadow-black text-cyan-600 rounded-lg text-center mr-5 ml-5'>
                    <Link href="https://soap2day.rs/movie/watch-kingdom-of-the-planet-of-the-apes-full-108877"> <Image src="/kali.png" alt='kali' width={100} height={100} className='hover:opacity-80  w-full'></Image></Link>
                    <Link href="https://soap2day.rs/movie/watch-kingdom-of-the-planet-of-the-apes-full-108877"> <h1 className='text-2xl font-bold'>Lal Mirch</h1></Link>
                ...
                <div className='border-blue-400 border-x-4 border-y-4 hover:shadow-2xl hover:shadow-black text-cyan-600 rounded-lg text-center mr-5 ml-5'>
                    <Link href="https://soap2day.rs/movie/watch-kingdom-of-the-planet-of-the-apes-full-108877"> <Image src="/lal.png" alt='lal' width={200} height={200} className='hover:opacity-80  w-full'></Image></Link>
                    <Link href="https://soap2day.rs/movie/watch-kingdom-of-the-planet-of-the-apes-full-108877"> <h1 className='text-2xl font-bold'>Lal Mirch</h1></Link>
