  ...
  return (
    ...
    <div className='grid grid-cols-2 items-center  justify-items-center sm:grid-cols-1 sm:mt-10 lg:grid-cols-2'>
           <div className='border-blue-400 border-x-4 border-y-4 hover:shadow-2xl hover:shadow-black text-cyan-600 rounded-lg text-center mt-20'>
                    <Link href="http://localhost:3000/pic1/1kg"> <Image src="/lal.png" alt='lal' width={500} height={500} className='hover:opacity-80  '></Image></Link>
                    <Link href="http://localhost:3000/pic1/kg"> <h1 className='text-2xl font-bold'>Lal Mirch</h1></Link>
                ...
                <div><Link href="https://wa.link/5qwogt"><button className='bg-black text-white px-5 py-3 rounded-full hover:shadow-black hover:shadow-2xl hover:bg-slate-500 sm:mt-10'>Place Order On Whatsapp</button></Link></div>
                </div>
